...
class PageFetalDeath extends Component
{
    ...
    {
        return view('livewire.lcr.page-fetal-death',[
            'records' => $this->rows
        ]);
    }
    ...
    {
        $this->fetal_death_id = $id;
        $this->showDeleteSingleRecordModal = true;
    }

    public function deleteSingleRecord()
    {
        FetalDeath::destroy($this->fetal_death_id);
    ...
    public function setFields($data)
    {
        ...
        $this->age_days = $data['age_days'];
        $this->age_hrs = $data['age_hrs'];
