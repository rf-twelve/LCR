...
class MaintenanceRequestForms extends Component
{
    ...
    {
        return redirect(route('maintenance-request-form.create',[
    ...
    {
        MaintenanceRequest::destroy($this->delete_single_record_id);
    ...
    public function getRowsQueryProperty()
    {
        ...
        return MaintenanceRequest::query()
            ->with('author','images','vehicle','work_orders')
    ...
    {
        // dd($this->rows);
        return view('livewire.bgmd.maintenance-request-forms',[
            'records' => $this->rows,
        ]);
    }
}
