...
use App\Http\Livewire\Bgmd\ChargeSlipPrint;
...
use App\Http\Livewire\Bgmd\EquipmentPrint;
...
use App\Http\Livewire\Bgmd\MaintenanceRequestFormPrint;
...
use App\Http\Livewire\Bgmd\VehicleMaintenanceLogPrint;
use App\Http\Livewire\Bgmd\VehiclePrint;
...
use App\Http\Livewire\Bgmd\WorkOrderSlipPrint;
...
Route::group(['prefix' => 'user',  'middleware' => 'auth'], function()
{
    ...
    Route::get('{user_id}/equipment/{id}/print', [EquipmentPrint::class, 'print'])->name('equipment.print');
    ...
    Route::get('{user_id}/maintenance-request-form/{id}/print', [MaintenanceRequestFormPrint::class, 'print'])->name('maintenance-request-form.print');
    ...
    Route::get('{user_id}/vehicle/{id}/print', [VehiclePrint::class, 'print'])->name('vehicle.print');
    ...
    Route::get('{user_id}/work-order-slip/{id}/print', [WorkOrderSlipPrint::class,'print'])->name('work-order-slip.print');

    Route::get('{user_id}/vehicle-maintenance-log/{id}/print', [VehicleMaintenanceLogPrint::class,'print'])->name('vehicle-maintenance-log.print');
    ## USER MANAGEMENT
