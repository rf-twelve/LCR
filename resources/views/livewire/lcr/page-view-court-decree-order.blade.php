                                        ...
                                        <div class="flex space-x-3">
                                            <div class="flex-1 space-y-1">
                                                <h3 class="text-sm font-medium">CITIZENSHIP :</< /h3>
                                                    <p class="text-sm text-gray-500">{{ $data['subject_citizenship'] }}
                                                    </p>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="py-4">
                                        <div class="flex space-x-3">
                                            <div class="flex-1 space-y-1">
                                                ...
                                                <p class="text-sm text-gray-500">{{ $data['petitioner_citizenship'] }}
                                                </p>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="py-4">
                                        <div class="flex space-x-3">
                                            <div class="flex-1 space-y-1">
                                                ...
                                                <p class="text-sm text-gray-500">{{ $data['special_proceeding_no'] }}
                                                </p>
                                            </div>
                                        </div>
                                    </li>
                        ...
                        <div class="min-h-screen pb-6 bg-white shadow">
                            <div class="sm:items-baseline sm:justify-between">
                                ...
                                <div class="p-4 space-y-6 divide-y divide-gray-200 sm:space-y-5">
                                    ...
                                    <img class="object-cover object-center w-full p-2" src="{{ $image->imageUrl() }}"
                                        alt="An image file">
                                    @empty
