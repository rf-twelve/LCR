                    ...
                    <div class="mt-4">
                        <form wire:submit.prevent="save" enctype="multipart/form-data" class="grid font-medium gap-y-1 gap-x-2 sm:grid-cols-4 sm:gap-x-8">
                            ...
                            <div class="flex space-y-1 sm:col-span-4">
                                <label for="dateTime" class="w-40 py-2 text-sm">Date :</label>
                                <x-input wire:model.lazy="date" id="dateTime" type="date"/>
                                            ...
                                            <x-slot name="body">
                                                ...
                                                <x-table.row>
                                                    ...
                                                    @if (count($charge_slip_items) > 0)
                                                        ...
                                                        <td>
                                                            <span class="text-lg font-medium">P {{ number_format($grand_total, 2,'.',',') }}</span>
                                                        </td>
                                                    @endif
