                        ...
                        <div class="flex-shrink-0">
                            <div class="flex justify-between px-6 py-2 text-sm font-medium text-gray-700 bg-blue-300 border-t border-b border-gray-200">
                                <div class="flex">
                                    ...
                                    <span class="pl-2">EQUIPMENT INFO</span>
                                    @if ($author_id == auth()->user()->id)
                                        <a href="{{ route('equipment.edit',['user_id'=>auth()->user()->id, 'id'=> $equip_id]) }}" class="flex ml-3 text-indigo-600 hover:text-indigo-900">
                            ...
                            <div class="sm:items-baseline sm:justify-between">
                                ...
                                <div class="flex justify-between px-6 py-2 text-sm font-medium text-gray-700 bg-blue-300 border-t border-b border-gray-200">
                                    <div class="flex">
                                        ...
                                        <span class="pl-2">EQUIPMENT MAINTENANCE LOG</span>
                                    </div>
                                </div>
