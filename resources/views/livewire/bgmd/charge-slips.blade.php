                    ...
                    <x-table>
                        <x-slot name="head">
                            ...
                            <x-table.head class="px-2 py-1" sortable wire:click="sortBy('to')"
                                :direction="$sortField === 'to' ? $sortDirection : null">To</x-table.head>

                            <x-table.head class="w-10 px-2 py-1" sortable wire:click="sortBy('from')"
                                :direction="$sortField === 'from' ? $sortDirection : null">From</x-table.head>

                            <x-table.head class="px-2 py-1" sortable wire:click="sortBy('for')"
                                :direction="$sortField === 'for' ? $sortDirection : null">For</x-table.head>

                            <x-table.head class="px-2 py-1" sortable wire:click="sortBy('prepared_by')"
                                :direction="$sortField === 'prepared_by' ? $sortDirection : null">Prepared By</x-table.head>

                            <x-table.head class="px-2 py-1" sortable wire:click="sortBy('noted_by')"
                                :direction="$sortField === 'noted_by' ? $sortDirection : null">Noted By</x-table.head>
