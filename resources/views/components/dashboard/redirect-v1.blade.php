...
<ul role="list" class="grid grid-cols-1 gap-6 pt-4 sm:grid-cols-2 lg:grid-cols-3">
    ...
    <li class="col-span-1 bg-white divide-y divide-gray-200 rounded-lg shadow">
        ...
        <div class="p-2">
            <div class="flex mt-1 rounded-md shadow-sm">
                <div class="relative flex items-stretch flex-grow focus-within:z-10">
                    <x-form.input-text wire:model='search_marriage' type="search" placeholder="Enter LCR Number" class="pl-2 border rounded-none rounded-l-md"/>
                </div>
    ...
    <li class="col-span-1 bg-white divide-y divide-gray-200 rounded-lg shadow">
        ...
        <div class="p-2">
            <div class="flex mt-1 rounded-md shadow-sm">
                <div class="relative flex items-stretch flex-grow focus-within:z-10">
                    <x-form.input-text wire:model='searchMarriageLicense' type="search" placeholder="Enter Register Number" class="pl-2 border rounded-none rounded-l-md"/>
                </div>
