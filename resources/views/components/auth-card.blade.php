...
<div class="flex min-h-screen bg-white">
        ...
        <div class="w-full max-w-sm mx-auto lg:w-96">
            <div class="text-center">
                <div class="inline-block max-w-[160px] mx-auto">
                    <img class="w-auto h-12 mx-auto" src="{{ $company ? $company->logoUrl() : '' }}" alt="Company Logo" />
            ...
            <div class="mb-10 text-center">
                <div class="inline-block max-w-[300px] mx-auto">
                    <span class="font-sans text-2xl font-bold">
                        {{ $company ? $company->system : 'System Name' }}
                    </span><br>
    ...
    <div class="relative flex-1 hidden w-0 lg:block">
        ...
        src="{{ $company ? $company->bgUrl() : '' }}" alt="Company office" />
    </div>
</div>
